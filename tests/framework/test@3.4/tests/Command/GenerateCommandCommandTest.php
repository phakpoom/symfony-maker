...
class GenerateCommandCommandTest extends AbstractGenerateCommandWebTestCase
{
    public function testWithDummy()
    {
        ...
        $this->assertFileHasCreated(realpath(__DIR__ . '/../../src/AppBundle/') . '/Command/DummyCommand.php' , $output);
        $this->assertFileHasCreated(realpath(__DIR__ . '/../../src/AppBundle/') . '/Resources/config/services.xml' , $output);
        $this->assertFileHasCreated(realpath(__DIR__ . '/../../src/AppBundle/') . '/Resources/config/services/commands.xml' , $output);
    }
    ...
    public function testWithSubModule()
    {
        ...
        $this->assertFileHasCreated(realpath(__DIR__ . '/../../src/AppBundle/SubModule/SomeFeature2') . '/Command/DummyCommand.php' , $output);
        $this->assertFileHasCreated(realpath(__DIR__ . '/../../src/AppBundle/SubModule/SomeFeature2') . '/Resources/config/services.xml' , $output);
        $this->assertFileHasCreated(realpath(__DIR__ . '/../../src/AppBundle/SubModule/SomeFeature2') . '/Resources/config/services/commands.xml' , $output);
    }

    protected function getCommand(): GenerateCommandCommand
    {
        self::bootKernel();
        return self::$kernel->getContainer()->get(GenerateCommandCommand::class);
    }
}
