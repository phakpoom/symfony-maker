...
use Bonn\Maker\Bridge\MakerBundle\Command\GenerateDoctrineEventListenerCommand;
...
class GenerateDoctrineEventListenerCommandTest extends AbstractGenerateCommandWebTestCase
{
    ...
    protected function getCommand(): GenerateDoctrineEventListenerCommand
    {
        self::bootKernel();
        return self::$container->get(GenerateDoctrineEventListenerCommand::class);
    }
}
